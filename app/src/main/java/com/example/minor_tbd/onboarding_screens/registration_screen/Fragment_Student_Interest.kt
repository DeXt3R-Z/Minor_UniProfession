        ...
        v.apply {
            ...
            interestAndroidAppDev.setOnClickListener() {
                if (checkSelectedList[0] == 0) {
                    ...
                    textAndroidAppDev.setTextColor(ContextCompat.getColor(context,
            ...
            interestCloudComputing.setOnClickListener() {
                if (checkSelectedList[2] == 0) {
                    ...
                    textCloudComputing.setTextColor(ContextCompat.getColor(context,
                        R.color.gradient_green
                    ))
            ...
            interestDataScience.setOnClickListener() {
                if (checkSelectedList[4] == 0) {
                    ...
                    textDataScience.setTextColor(ContextCompat.getColor(context,
                        R.color.gradient_green
                    ))
            ...
            interestDataAnalytics.setOnClickListener() {
                if (checkSelectedList[5] == 0) {
                    ...
                    textDataAnalytics.setTextColor(ContextCompat.getColor(context,
                        R.color.gradient_green
                    ))
            ...
            interestMachineLearning.setOnClickListener() {
                if (checkSelectedList[7] == 0) {
                    ...
                    textMachineLearning.setTextColor(ContextCompat.getColor(context,
                        R.color.gradient_green
                    ))
